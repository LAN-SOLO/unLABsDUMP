  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="space-y-2">
        <label className="text-sm font-medium text-[#00CC33]">Search by Name or Description</label>
        <div className="relative">
          ...
          <Input
            ...
            className="pl-10 bg-[#0D1117] border-[#1A3A2A] text-[#00FF41] placeholder:text-[#1A6B35] focus-visible:border-[#00FF41]"
          />
        </div>
      </div>
      ...
      {/* Owner wallet */}
      <div className="space-y-2">
        <label className="text-sm font-medium text-[#00CC33]">Owner Wallet Address</label>
        <Input
          type="text"
          value={values.ownerWallet}
          onChange={(e) => setValues((prev) => ({ ...prev, ownerWallet: e.target.value }))}
          placeholder="Solana wallet address..."
          className="bg-[#0D1117] border-[#1A3A2A] text-[#00FF41] placeholder:text-[#1A6B35] font-mono text-xs focus-visible:border-[#00FF41]"
        />
      </div>
      ...
      <div className="space-y-3">
        <label className="text-sm font-medium text-[#00CC33]">Color Wavelength</label>
            ...
            <label
              ...
              className={cn(
                ...
                values.colors.includes(color)
                  ? 'border-[#00FF41]/50 bg-[#0D3B1E]/20'
                  : 'border-[#0D3B1E] hover:border-[#1A3A2A]'
              )}
            >
              <Checkbox
              ...
              />
              <span className="text-xs text-[#00CC33]">{color}</span>
            </label>
          ))}
        </div>
      </div>
      ...
      {/* Tier */}
      <div className="space-y-3">
        <label className="text-sm font-medium text-[#00CC33]">Tier</label>
          ...
          {NFT_TIERS.map((tier) => (
            ...
            >
              <Checkbox
                ...
                className="border-[#1A3A2A] data-[state=checked]:bg-[#00FF41] data-[state=checked]:border-[#00FF41]"
              />
              <span className="text-sm text-[#00CC33]">
      ...
      {/* Era */}
      <div className="space-y-3">
        <label className="text-sm font-medium text-[#00CC33]">Era</label>
        <div className="flex flex-wrap gap-2">
          {NFT_ERAS.map((era) => (
            <label
              key={era}
            ...
            >
              <Checkbox
                ...
                className="border-[#1A3A2A] data-[state=checked]:bg-[#00FF41] data-[state=checked]:border-[#00FF41]"
              />
              <span className="text-sm text-[#00CC33] font-mono">{era}</span>
            </label>
          ))}
        </div>
      </div>
      ...
      {/* Rarity range */}
      <div className="space-y-3">
        <label className="text-sm font-medium text-[#00CC33]">Rarity Score Range</label>
        <div className="flex items-center gap-3">
          <Input
            ...
            placeholder="Min (0)"
            className="bg-[#0D1117] border-[#1A3A2A] text-[#00FF41] placeholder:text-[#1A6B35] w-28 focus-visible:border-[#00FF41]"
          />
          <span className="text-[#1A6B35]">to</span>
          <Input
            type="number"
            min={0}
            max={100}
      ...
      <div className="flex items-center gap-3">
        <Button
          type="submit"
          disabled={loading}
          className="bg-[#00FF41] text-black hover:bg-[#00CC33] glow-button flex-1 sm:flex-none"
        >
        ...
        <Button
          ...
          variant="outline"
          onClick={handleReset}
          className="border-[#1A3A2A] text-[#00AA2A] hover:text-[#00FF41]"
        >
